...
export default function BackgroundColorControl({
  ...
  return (
    <div className={`relative ${className}`} ref={popoverRef}>
      ...
      {isOpen ? (
        <div className="absolute right-0 mt-3 w-[calc(100vw-2rem)] max-w-xs rounded-2xl border border-gray-100 bg-white p-4 shadow-xl dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 text-slate-500 transition hover:bg-gray-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
          ...
          <div className="mt-4 flex items-center gap-3">
            <input
              ...
              className="h-12 w-12 cursor-pointer rounded-xl border border-gray-200 bg-white p-1 dark:border-slate-700 dark:bg-slate-950"
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
            >
